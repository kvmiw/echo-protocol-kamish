...
namespace Content.Client.Administration.UI.Tabs.AdminbusTab
{
    ...
    {
        private readonly EchoEntitySpawningUIController _entitySpawningController;  // ECHO-Tweak: замена на наш изменённый ЮИ
        ...
        public AdminbusTab()
        {
            ...
            _entitySpawningController = UserInterfaceManager.GetUIController<EchoEntitySpawningUIController>(); // ECHO-Tweak: замена на наш изменённый ЮИ
